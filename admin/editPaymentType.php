...
<form name="myForm" enctype="multipart/form-data" method="POST" action="updatePaymentType.php">
    <table class="border">
        <thead>
            <tr>
                <th class="border p-2">付款方式名稱</th>
                <th class="border p-2">付款方式圖片</th>
        ...
        ?>
            <tr>
                <td class="border p-3">
                    <input class="form-control" type="text" name="paymentTypeName" value="<?php echo $arr[0]['paymentTypeName']; ?>" maxlength="100" />
                </td>
                <td class="border p-3">
        ...
        <tfoot>
            <tr>
                <td class="border" colspan="4"><input class="smbtn btn btn-outline-light float-left m-2" type="submit" name="smb" value="更新"></td>
            </tr>
        </tfoot>
    </table>
